...
is available at 
https://github.com/aviad-buskila/llm\_clinical\_reproducibility/tree/v1.0.0.
\end{abstract}
...
all three paraphrase rather than recall.
...
reporting within-model variance conceal this risk entirely.
...
First, \textbf{low temperature does not buy reproducibility}.
Even at $T{=}0.2$, self-agreement rates hover between 0.12 and 0.20,
and 87--97\% of all outputs per model are unique.
Any clinical deployment must account for this variance through
